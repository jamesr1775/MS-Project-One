...
2. There will be information on the companys passion and skills along with pictures to compliment our products or staff.
...
3. As a potential Customer, I want to be able to find your social media, so I can know more about the company news and upcoming events or offers. 
    * At the bottom of every page, the companys social media links are presented and standout in a contrasting style.
...
- Got some inspiration with writing the read me from the [Code institutes github](https://github.com/Code-Institute-Solutions/SampleREADME) and from [Anna Gilhespy's github](https://github.com/AJGreaves/portrait-artist) posted in the slack group.